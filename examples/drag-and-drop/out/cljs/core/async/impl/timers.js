...
var skip_list_node__3 = (function (k,v,level){var arr = (new Array((level + (1))));var i_15372 = (0);while(true){
if((i_15372 < arr.length))
{(arr[i_15372] = null);
{
var G__15373 = (i_15372 + (1));
i_15372 = G__15373;
continue;
}
} else
...
{var i_15379 = (self__.level + (1));while(true){
...
var coll = this;var update = (new Array(cljs.core.async.impl.timers.MAX_LEVEL));var x = cljs.core.async.impl.timers.least_greater_node.call(null,self__.header,k,self__.level,update);var x__$1 = (x.forward[(0)]);if((!((x__$1 == null))) && ((x__$1.key === k)))
{var i_15381 = (0);while(true){
if((i_15381 <= self__.level))
{var links_15382 = (update[i_15381]).forward;if(((links_15382[i_15381]) === x__$1))
