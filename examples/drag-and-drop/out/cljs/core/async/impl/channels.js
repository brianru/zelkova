...
goog.require('cljs.core.async.impl.protocols');
cljs.core.async.impl.channels.box = (function box(val){if(typeof cljs.core.async.impl.channels.t10681 !== 'undefined')
{} else
{
/**
* @constructor
*/
cljs.core.async.impl.channels.t10681 = (function (val,box,meta10682){
this.val = val;
this.box = box;
...
cljs.core.async.impl.channels.t10681.cljs$lang$type = true;
cljs.core.async.impl.channels.t10681.cljs$lang$ctorStr = "cljs.core.async.impl.channels/t10681";
cljs.core.async.impl.channels.t10681.cljs$lang$ctorPrWriter = (function (this__4215__auto__,writer__4216__auto__,opt__4217__auto__){return cljs.core._write.call(null,writer__4216__auto__,"cljs.core.async.impl.channels/t10681");
});
cljs.core.async.impl.channels.t10681.prototype.cljs$core$IDeref$_deref$arity$1 = (function (_){var self__ = this;
var ___$1 = this;return self__.val;
});
cljs.core.async.impl.channels.t10681.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_10683){var self__ = this;
var _10683__$1 = this;return self__.meta10682;
});
cljs.core.async.impl.channels.t10681.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_10683,meta10682__$1){var self__ = this;
var _10683__$1 = this;return (new cljs.core.async.impl.channels.t10681(self__.val,self__.box,meta10682__$1));
});
cljs.core.async.impl.channels.__GT_t10681 = (function __GT_t10681(val__$1,box__$1,meta10682){return (new cljs.core.async.impl.channels.t10681(val__$1,box__$1,meta10682));
});
}
return (new cljs.core.async.impl.channels.t10681(val,box,null));
});
...
cljs.core.async.impl.channels.MMC = (function (){var obj10685 = {};return obj10685;
})();
...
{}
while(true){
var taker_10686 = self__.takes.pop();if((taker_10686 == null))
{} else
{if(cljs.core.async.impl.protocols.active_QMARK_.call(null,taker_10686))
{var take_cb_10687 = cljs.core.async.impl.protocols.commit.call(null,taker_10686);var val_10688 = (cljs.core.truth_((function (){var and__3627__auto__ = self__.buf;if(cljs.core.truth_(and__3627__auto__))
{return (cljs.core.count.call(null,self__.buf) > (0));
} else
{return and__3627__auto__;
}
})())?cljs.core.async.impl.protocols.remove_BANG_.call(null,self__.buf):null);cljs.core.async.impl.dispatch.run.call(null,((function (take_cb_10687,val_10688,taker_10686,this$__$1){
return (function (){return take_cb_10687.call(null,val_10688);
});})(take_cb_10687,val_10688,taker_10686,this$__$1))
);
} else
{}
{
...
{} else
{var putter_10689 = self__.puts.pop();if((putter_10689 == null))
{} else
{var put_handler_10690 = putter_10689.handler;var val_10691 = putter_10689.val;if(cljs.core.async.impl.protocols.active_QMARK_.call(null,put_handler_10690))
{var put_cb_10692 = cljs.core.async.impl.protocols.commit.call(null,put_handler_10690);cljs.core.async.impl.protocols.commit.call(null,handler);
cljs.core.async.impl.dispatch.run.call(null,((function (put_cb_10692,put_handler_10690,val_10691,putter_10689,_,retval,this$__$1){
return (function (){return put_cb_10692.call(null,true);
});})(put_cb_10692,put_handler_10690,val_10691,putter_10689,_,retval,this$__$1))
);
if(cljs.core.reduced_QMARK_.call(null,self__.add_BANG_.call(null,self__.buf,val_10691)))
...
{var taker_10693 = self__.takes.pop();if(cljs.core.async.impl.protocols.active_QMARK_.call(null,taker_10693))
{var take_cb_10694 = cljs.core.async.impl.protocols.commit.call(null,taker_10693);var val_10695__$1 = cljs.core.async.impl.protocols.remove_BANG_.call(null,self__.buf);cljs.core.async.impl.dispatch.run.call(null,((function (take_cb_10694,val_10695__$1,taker_10693,done_QMARK_,closed__$1,this$__$1){
return (function (){return take_cb_10694.call(null,val_10695__$1);
});})(take_cb_10694,val_10695__$1,taker_10693,done_QMARK_,closed__$1,this$__$1))
);
} else
{{
continue;
...
var putter_10696 = self__.puts.pop();if((putter_10696 == null))
{} else
{var put_handler_10697 = putter_10696.handler;var val_10698 = putter_10696.val;if(cljs.core.async.impl.protocols.active_QMARK_.call(null,put_handler_10697))
{var put_cb_10699 = cljs.core.async.impl.protocols.commit.call(null,put_handler_10697);cljs.core.async.impl.dispatch.run.call(null,((function (put_cb_10699,put_handler_10697,val_10698,putter_10696,this$__$1){
return (function (){return put_cb_10699.call(null,true);
...
return (function() {
var G__10704 = null;
var G__10704__1 = (function (buf__$1){try{return add_BANG_.call(null,buf__$1);
}catch (e10702){var t = e10702;return cljs.core.async.impl.channels.handle.call(null,buf__$1,exh,t);
}});
var G__10704__2 = (function (buf__$1,val){try{return add_BANG_.call(null,buf__$1,val);
}catch (e10703){var t = e10703;return cljs.core.async.impl.channels.handle.call(null,buf__$1,exh,t);
}});
G__10704 = function(buf__$1,val){
switch(arguments.length){
case 1:
return G__10704__1.call(this,buf__$1);
case 2:
return G__10704__2.call(this,buf__$1,val);
}
